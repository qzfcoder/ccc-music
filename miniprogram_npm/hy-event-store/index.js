...
__DEFINE__(1642224648120, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642224648121,"./event-store":1642224648122}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642224648121, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642224648122, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642224648121,"./utils":1642224648123}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642224648123, function(require, module, exports) {
...
return __REQUIRE__(1642224648120);
})()
